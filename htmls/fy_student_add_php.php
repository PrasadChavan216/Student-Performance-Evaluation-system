 ...
 if(isset($_POST))
{
	...
	$seat_no 		= $_POST['seat_no'];
		 ...
		 $sql_E = "SELECT * FROM fy_stud_data WHERE seat_no = '$seat_no' ";
	...
	else
	{
		...
		$query = "INSERT INTO fy_stud_data(first_name, last_name, address, email, phone, seat_no ) VALUES('$firstname','$lastname','$address','$email','$phonenumber','$seat_no')";
