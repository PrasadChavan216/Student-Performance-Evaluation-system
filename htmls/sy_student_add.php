...
<body>
    ...
    <div class="regform">
        <h1>Add SY Student</h1>
    </div>
    
    <div class="main">

        <form action="sy_student_add_php.php" method="POST">
            ...
            <label class="phone-number">Phone Number</label>
             ...
             <h2 class="name">
            Seat Number</h2>
            <input class="firstname" id="cap" onblur="mycapital()" type="text" name="seat_no" required="" value="SY-">
